      ...
      <div className="max-w-md mx-auto">
        <nav className="flex items-center justify-around bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 h-16 px-4">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? "text-brand dark:text-brand-muted" : "text-slate-600 dark:text-slate-400",
          ...
          {isGuest && (
            <Link 
              href="/signup" 
              className="flex flex-col items-center justify-center w-full h-full text-slate-600 dark:text-slate-400 hover:text-brand dark:hover:text-brand-muted transition-all duration-300 ease-in-out transform hover:scale-110 hover:rotate-2"
            >
